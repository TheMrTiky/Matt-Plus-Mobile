...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Change Character', "Value 1: Character to change (Dad, BF, GF)\nValue 2: New character's name"],
                ['Arrow flip', "Wanna turn this into notITG? this is the event for you!\n\nFor the low low cost of your players santiy.\nThis event will invert the arrows of your player\n\nSet value 1 to '1' to set the arrows back to their original spot\n\nValue 2 controls how fast the notes switch"],
                ['bob jumpscare', "DIE!!!"],
                ['camera bounce', "boing"],
                ['cheating mechanic', "cheating mechanic"],
                ['defeat script', "no miss or die"],
                ...
                ['Flash', "Smoothly sets the Opponent's transparency value.\n\nValue 1: Duration\nValue 2: 0 is Black, 1 is White, 2 is Red, 3 is Green, 4 is Blue and 5 is Yellow"],
                ['Flicker', "Flicker"],
                ['funni mechanic haha', "haha"],
                ...
                ['missingno mechanic', "randomly places keys anywhere on screen\n(note: can be offscreen to 0_0)"],
                ['MoveArrow', "Change Note Position\n\nValue 1: Note (0-7)\nValue 2: x value, y value, rotation, opacity (0-1), duration"],
                ['note dance', "Note dance"],
                ['note hit follow', "when opponent hits note then well uh yeah\nty HafimieForever for script :D"],
                ['ScreenStuff', "Value 1: angle\nValue 2: time"],
                ['Set_Health', "Set health amount\n\nValue 1: Amount of health"],
                ['sing shake', "example: ruv makes da screen shake when he sing"],
                ['sound player', "must have sound in sound file to play\nmust also be ogg"],
                ['static v2', "tiky"],
                ['transparent notes', "yooooooooooooo"],
